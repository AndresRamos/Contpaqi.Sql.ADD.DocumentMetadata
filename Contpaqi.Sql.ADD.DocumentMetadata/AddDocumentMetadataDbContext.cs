...
{
    public class AddDocumentMetadataDbContext : DbContext
    {
        protected AddDocumentMetadataDbContext()
        {
        }

        protected AddDocumentMetadataDbContext(DbCompiledModel model) : base(model)
        {
        }

        public AddDocumentMetadataDbContext(string nameOrConnectionString) : base(nameOrConnectionString)
        {
        }

        public AddDocumentMetadataDbContext(string nameOrConnectionString, DbCompiledModel model) : base(nameOrConnectionString, model)
        {
        }

        public AddDocumentMetadataDbContext(DbConnection existingConnection, bool contextOwnsConnection) : base(existingConnection, contextOwnsConnection)
        {
        }

        public AddDocumentMetadataDbContext(DbConnection existingConnection, DbCompiledModel model, bool contextOwnsConnection) : base(existingConnection, model, contextOwnsConnection)
        {
        }
